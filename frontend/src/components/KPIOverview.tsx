  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      ...
      <div className="glass-card glass-card-interactive p-6 relative overflow-hidden group">
        ...
        <div className="mt-4">
          <div
            className="text-xl font-display font-bold text-[#FAFAFA] truncate"
            title={nextPayment ?? "None"}
          >
      ...
      {/* Active Alerts */}
      <div
        className={`glass-card glass-card-interactive p-6 relative overflow-hidden group ${alertCount > 0 ? "glass-card-highlight" : ""}`}
      >
        <div className="flex items-center justify-between">
          <span className="text-[11px] font-mono font-medium text-zinc-500 uppercase tracking-wider">
            Attention
