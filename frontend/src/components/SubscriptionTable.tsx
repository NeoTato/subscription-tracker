              ...
              <tr>
                <td colSpan={8} className="py-14 text-center text-slate-400 font-sans">
                  <div className="flex flex-col items-center justify-center max-w-xs mx-auto">
                    ...
                    <p className="text-sm font-medium text-slate-200">No subscriptions found</p>
                    ...
                    {onAddClick && (
                      <button
                        onClick={onAddClick}
                        className="flex items-center gap-2 px-3.5 py-1.5 bg-slate-800/90 hover:bg-slate-700 text-slate-100 text-xs font-medium rounded-lg border border-slate-700 hover:border-slate-600 shadow-sm transition active:scale-95"
                      >
