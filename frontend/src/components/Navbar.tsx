      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="font-bold text-lg text-white tracking-tight">SubSentry</span>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <button
            ...
            className="p-2 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-800 transition border border-transparent hover:border-slate-700 disabled:opacity-50"
          >
          ...
          <button
            ...
            className="relative p-2 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-800 transition border border-transparent hover:border-slate-700"
          >
          ...
          <button
            onClick={onAddClick}
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-gradient-to-r from-brand-600 to-cyan-600 hover:from-brand-500 hover:to-cyan-500 text-white font-medium text-sm shadow-md shadow-brand-600/20 transition active:scale-95"
          >
