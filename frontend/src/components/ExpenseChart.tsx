  ...
  if (!categories || categories.length === 0) {
    return (
      <div className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800 flex flex-col items-center justify-center text-center h-[320px]">
        ...
        <p className="text-sm font-medium text-slate-400">No expense breakdown data</p>
        <p className="text-xs text-slate-500 mt-1">Add subscriptions to see your spending analytics.</p>
      </div>
    );
  }
