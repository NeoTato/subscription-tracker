      ...
      <div className="w-full max-w-lg rounded-2xl bg-[#0F0F17]/95 border border-white/[0.1] shadow-[0_25px_60px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 flex-1 text-xs font-sans">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div>
              <label className="block text-zinc-400 font-medium mb-1.5">Service Name *</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-zinc-400 font-medium mb-1.5">Platform / Provider</label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-3 gap-3.5">
            <div>
              <label className="block text-zinc-400 font-medium mb-1.5">Price *</label>
              <input
                type="number"
                step="any"
                min="0.01"
            ...
            <div>
              <label className="block text-zinc-400 font-medium mb-1.5">Currency</label>
              <select
            ...
            <div>
              <label className="block text-zinc-400 font-medium mb-1.5">Billing Cycle</label>
              <select
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div>
              <label className="block text-zinc-400 font-medium mb-1.5">Next Renewal Date *</label>
              <input
                type="date"
                required
          ...
          <div className="grid grid-cols-2 gap-3.5">
            <div>
              <label className="block text-zinc-400 font-medium mb-1.5">Plan Structure</label>
              <select
              ...
              >
                {PLAN_TYPES.map((p) => (
                  <option key={p} value={p} className="bg-[#12121A]">{p}</option>
                ))}
              </select>
            </div>
            <div>
              <label className="block text-zinc-400 font-medium mb-1.5">Tier / Plan Level</label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div>
              <label className="block text-zinc-400 font-medium mb-1.5">Payment Method</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-zinc-400 font-medium mb-1.5">Student Expiry (Optional)</label>
              <input
                type="date"
          ...
          <div className="p-4 bg-[#12121A] rounded-xl border border-white/[0.06] space-y-3">
            <label className="flex items-center justify-between cursor-pointer">
              <span className="text-zinc-200 font-medium">I personally pay for this</span>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between cursor-pointer">
              <div>
                <span className="text-zinc-200 font-medium block">Remind me to cancel</span>
                <span className="text-[10px] text-zinc-500">Triggers urgent alert before upcoming cycle</span>
              </div>
              <input
                type="checkbox"
          ...
          {/* Notes */}
          <div>
            <label className="block text-zinc-400 font-medium mb-1.5">Notes / Description</label>
            <textarea
              rows={2}
