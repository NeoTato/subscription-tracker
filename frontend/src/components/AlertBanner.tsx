          ...
          <div className="flex items-start sm:items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400 font-sans mt-0.5">
                Marked for cancellation. Scheduled charge:{" "}
        ...
        >
          <div className="flex items-start sm:items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400 font-sans mt-0.5">
                <span className="font-mono text-zinc-300">
                  {due.currency} {due.price.toFixed(2)}
                </span>{" "}
                ({due.billing_cycle}) scheduled on{" "}
                {new Date(due.next_due_date).toLocaleDateString("en-US", {
                  month: "long",
                  day: "numeric",
                  year: "numeric",
                })}
        ...
        >
          <div className="flex items-start sm:items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400 font-sans mt-0.5">
                Educational discount expires on{" "}
                {new Date(exp.student_status_expiry).toLocaleDateString(
                  "en-US",
                  { month: "short", day: "numeric" },
                )}
                . Verify credentials to renew student rate.
              </p>
            </div>
          </div>
        </div>
